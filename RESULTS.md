...
| A23–A25, A32, A33, A40, A41 | **not_run** | A23 in progress: the op-coverage ledger is derived (`tools/op_census.zeph`, 25 ops) and 4 of the 5 device kernels are written and validated. |
